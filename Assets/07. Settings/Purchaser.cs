...
namespace CompleteProject
{
    ...
    public class Purchaser : Singleton<Purchaser>, IStoreListener
    {
        ...
        #region IOS Product IDs 입니다! 열어서 확인하세요
        // Apple App Store-specific product identifier for the subscription product.
        private static readonly string kProductNameAppleSubscription = "com.unity3d.subscription.new";

        public static string AppleproductId0 = "com.actionfit.ios.jewelpiratematch.255000coin";
        public static string AppleproductId1 = "com.actionfit.ios.jewelpiratematch.142000coin";
        public static string AppleproductId2 = "com.actionfit.ios.jewelpiratematch.61000coin";
        public static string AppleproductId3 = "com.actionfit.ios.jewelpiratematch.27500coin";
        public static string AppleproductId4 = "com.actionfit.ios.jewelpiratematch.11100coin";
        public static string AppleproductId5 = "com.actionfit.ios.jewelpiratematch.2000coin";
        public static string AppleproductId6 = "com.actionfit.ios.jewelpiratematch.noad";
        public static string AppleproductId7 = "com.actionfit.ios.jewelpiratematch.coinbank";
        public static string AppleproductPackageId1 = "com.actionfit.ios.jewelpiratematch.package01";
        public static string AppleproductPackageId2 = "com.actionfit.ios.jewelpiratematch.package02";
        public static string AppleproductPackageId3 = "com.actionfit.ios.jewelpiratematch.package03";
        public static string AppleproductPackageId4 = "com.actionfit.ios.jewelpiratematch.package04";
        public static string AppleproductPackageId5 = "com.actionfit.ios.jewelpiratematch.package05";
        public static string AppleproductSeasonPackage = "com.actionfit.ios.jewelpiratematch.seasonpackage";
        ...
        public static string AppleProductLimitedPackage = "com.actionfit.ios.jewelpiratematch.package06";


        #endregion


        #region AOS Product IDs 입니다! 열어서 확인하세요

        // Google Play Store-specific product identifier subscription product.
        private static readonly string kProductNameGooglePlaySubscription = "com.unity3d.subscription.original";

        public static string GoogleproductId0 = "com.aos.jewel.match3.pirate.255000coin";
        public static string GoogleproductId1 = "com.aos.jewel.match3.pirate.142000coin";
        public static string GoogleproductId2 = "com.aos.jewel.match3.pirate.61000coin";
        public static string GoogleproductId3 = "com.aos.jewel.match3.pirate.27500coin";
        public static string GoogleproductId4 = "com.aos.jewel.match3.pirate.11100coin";
        public static string GoogleproductId5 = "com.aos.jewel.match3.pirate.2000coin";
        public static string GoogleproductId6 = "com.aos.jewel.match3.pirate.noads";
        public static string GoogleproductId7 = "com.aos.jewel.match3.pirate.piggybank";
        public static string GoogleproductPackageId1 = "com.aos.jewel.match3.pirate.package01";
        public static string GoogleproductPackageId2 = "com.aos.jewel.match3.pirate.package02";
        public static string GoogleproductPackageId3 = "com.aos.jewel.match3.pirate.package03";
        public static string GoogleproductPackageId4 = "com.aos.jewel.match3.pirate.package04";
        public static string GoogleproductPackageId5 = "com.aos.jewel.match3.pirate.package05";
        public static string GoogleproductPackageId6 = "com.aos.jewel.match3.pirate.package06";
        public static string GoogleproductPackageId7 = "com.aos.jewel.match3.pirate.package07";
        public static string GoogleproductLimitedPackage = "com.aos.jewel.match3.pirate.limitedpackage";
        public static string GoogleproductSeasonPackage = "com.aos.jewel.match3.pirate.seasonpackage";
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            else if (string.Equals(args.purchasedProduct.definition.id, GoogleproductId2, StringComparison.Ordinal))
            {
                ...
                if (PlayerData.GetInstance != null)
                {
                    PlayerData.GetInstance.Gold += 61000;
                    coin = obj.GetComponent<PopupManager>().GetCoin();
                    coin.GetComponent<Animator>().SetTrigger("Normal");
                }
            }
            ...
            else if (string.Equals(args.purchasedProduct.definition.id, GoogleproductSeasonPackage,
               StringComparison.Ordinal))
            {
                Debug.Log(string.Format("ProcessPurchase : PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            ...
            else if (string.Equals(args.purchasedProduct.definition.id, AppleproductSeasonPackage,
                StringComparison.Ordinal))
            {
                Debug.Log(string.Format("ProcessPurchase : PASS. Product: '{0}'", args.purchasedProduct.definition.id));
                if (PlayerData.GetInstance != null)
        ...
        public ShopItemInfo GetPackageItems(int num)
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                switch (num)
                {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        p = m_StoreController.products.WithID(GoogleproductSeasonPackage);
                        break;
            ...
            else
            {
                switch (num)
                {
                    ...
                    case 10:
                        p = m_StoreController.products.WithID(AppleproductSeasonPackage);
                        break;
                    default:
                        p = m_StoreController.products.WithID(AppleproductPackageId3);
                        break;
        ...
        public void InitializePurchasing()
        {
            ...
            builder.AddProduct(GoogleproductSeasonPackage, ProductType.Consumable);
            ...
            builder.AddProduct(AppleproductSeasonPackage, ProductType.Consumable);
        ...
        public bool PurchaserLoadCheck()
        {
            ...
            if (m_StoreController.products.WithID(GoogleproductSeasonPackage) == null) return false;
            ...
            if (m_StoreController.products.WithID(AppleproductSeasonPackage) == null) return false;
